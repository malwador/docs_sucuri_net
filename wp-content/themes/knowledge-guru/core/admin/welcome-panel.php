<div id="welcome-panel" class="welcome-panel kbg-welcome-panel">
    <a href="#" class="welcome-panel-close" id="kbg_welcome_box_hide">Dismiss</a>
    <div class="welcome-panel-content">
        <h2>Thank you for choosing KnowledgeGuru!</h2>
        ...
        <div class="welcome-panel-column-container">
            <div class="welcome-panel-column">
                ...
                <a class="button button-primary button-hero" href="<?php echo esc_url(admin_url('themes.php?page=kbg-importer')); ?>">Run wizard</a>
            </div>
            <div class="welcome-panel-column">
                ...
                <a class="button button-primary button-hero" href="<?php echo esc_url(admin_url('themes.php?page=kbg-plugins')); ?>">Install plugins</a>
            </div>
            <div class="welcome-panel-column welcome-panel-last">
                ...
                <a class="button button-primary button-hero" href="https://mekshq.com/documentation/knowledge-guru/" target="_blank">Read documentation</a>
            </div>
        </div>
    </div>
</div>