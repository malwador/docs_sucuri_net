<?php if ( kbg_get( 'display', 'footer' ) ): ?>

    <?php get_template_part( 'template-parts/general/ads/above-footer' ); ?>
...
<?php wp_footer(); ?>
    ...
    <script src="https://img6.wsimg.com/wrhs/e0592432e621561c33d2ff0014daad2c/consent-main.js"></script>
