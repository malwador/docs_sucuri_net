...
<article <?php post_class('kbg-tax kbg-card full-height kbg-tax-layout-b layout-b-'.$attributes['blockType'].' layout-kbg-tax-'.$attributes['blockType'].''); ?>>

    <div class="justify-content-center">
    
        <?php if ( $attributes['displayPostImage'] && $fimg = kbg_buddy_get_category_featured_image( 'kbg-tax-b', $category->term_id, $attributes['blockType'] ) ): ?>
