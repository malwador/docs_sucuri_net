...
<article <?php post_class('kbg-tax kbg-card full-height kbg-tax-layout-d layout-d-'.$attributes['blockType'].' layout-kbg-tax-'.$attributes['blockType'].''); ?>>

    <div class="justify-content-center">
    
        <?php if ( $attributes['displayPostImage'] && $fimg = kbg_buddy_get_category_featured_image( 'kbg-tax-d', $category->term_id, $attributes['blockType'] ) ): ?>
            <div class="entry-media kbg-card-<?php echo esc_attr( $attributes['blockType'] ); ?>">
        ...
        <div class="text--center">
            ...
            <?php echo sprintf( '<%s class="entry-title h4"><a href="%s">%s</a></%s>', $attributes['titleTag'], esc_url( get_term_link( $category->term_id, 'kbg_category' ) ),  $category->name, $attributes['titleTag'] ); ?>
