...
<?php $loop_class = $sidebar['position'] == 'none' ? 'col-12 col-md-6 col-lg-4' : 'col-12 col-md-6'; ?>

<article <?php post_class('kbg-tax-list kbg-card-p full-height kbg-card layout-a-list'); ?>>
    ...
    <div class="justify-content-center">
        ...
        <div class="card-list-padding">
			...
			<?php if( $attributes['displayReadMoreLink'] ): ?>
                <?php $classes = $attributes['readMoreLinkType'] == 'button' ? 'kbg-button button-primary button-small mt--md' : 'kbg-meta-link mt--lg' ?>
